  ...
  void avancer() 
{
    ...
    analogWrite(enA, 255); // Vitesse maximale pour le moteur A
    analogWrite(enB, 255); // Vitesse maximale pour le moteur B
}
...
//
  void loop() 
{
  // Faire tourner les moteurs en avance pendant 1 seconde
    avancer();
    delay(1000);
  ...
  // Faire tourner les moteurs à gauche pendant 1 seconde
    gauche();
    delay(1000);
  ...
  // Faire tourner les moteurs à droite pendant 1 seconde
    droite();
    delay(1000);
  ...
  // Faire tourner les moteurs en arrière pendant 1 seconde
    reculer();
    delay(1000);
